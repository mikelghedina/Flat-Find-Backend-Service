...
def read_csv_sarria_sant_gervasi_training():
    ...
    df_sarria_sant_gervasi = pd.read_csv('https://raw.githubusercontent.com/mikelghedina/Flat-Find-Backend-Service/master/flaskr/datos/datasets_Pisos.com/Alquileres_sarria_sant_gervasi.csv')
